...
export async function HomeTrustStrip() {
  ...
  return <div className="border-y border-border"><ul className="mx-auto grid max-w-6xl grid-cols-3 divide-x divide-border px-4 py-5 text-center text-[11px] leading-5 sm:px-6 sm:text-xs"><li data-reveal="load" style={{ "--i": 4 } as CSSProperties} className="px-2 sm:px-5">{shipping}</li><li data-reveal="load" style={{ "--i": 5 } as CSSProperties} className="px-2 sm:px-5">{t("home.trust.pago")}</li><li data-reveal="load" style={{ "--i": 6 } as CSSProperties} className="px-2 sm:px-5">{t("home.trust.atencion")}</li></ul></div>;
}