 ...
 */
export const esPY = {
  "home.hero.eyebrow": "Hecho a mano en Paraguay",
  "home.hero.titulo": "Encaje que se siente en casa.",
  "home.hero.texto": "Lencería bordada a mano en Itauguá, pensada para todos los días. Envíos a todo el país.",
  "home.hero.coleccion": "Ver colección",
  "home.hero.cta": "Ver colección",
  "home.hero.whatsapp": "Escribinos por WhatsApp",
  "home.hero.alt1": "Modelo junto a la ventana con conjunto de lenceria marfil de encaje nanduti bordado a mano en Paraguay",
  "home.hero.alt2": "Modelo junto a la ventana con camison de saten rosa viejo y escote de encaje hecho a mano",
  "home.hero.alt3": "Modelo con kimono corto de gasa marfil y flores de mburucuya bordadas a mano en las mangas",
  "home.hero.escena": "Escena {n}",
  "home.hero.pausar": "Pausar",
  "home.hero.reproducir": "Reproducir",
  "home.trust.envios": "Envíos a todo el país",
  "home.trust.pago": "Pago por transferencia o al recibir",
  "home.trust.atencion": "Atención por WhatsApp",
  "home.categorias.titulo": "Categorías",
  "home.categorias.texto": "Encontrá esa pieza que te acompaña todos los días.",
  "home.verTodo": "Ver todo",
  "home.verTodos": "Ver todos",
  "home.conjuntos": "Conjuntos",
  "home.story.eyebrow": "Nuestra historia",
  "home.story.titulo": "Cada pieza lleva días de trabajo",
  "home.story.p1": "En Itauguá, el ñandutí y los encajes de ao po’i se trabajan a mano, puntada a puntada. Cada pieza lleva el tiempo y el cuidado de quienes la hacen.",
  "home.story.p2": "Hacemos pequeñas series para cuidar cada detalle. Las variaciones del trabajo artesanal hacen que no haya dos piezas idénticas.",
  "home.story.link": "Ver conjuntos",
  "home.story.alt": "Detalle de un bralette tejido a crochet en algodon terracota con tiras para anudar",
  "home.comprar.titulo": "Cómo comprar",
  "home.comprar.numero1": "01",
  "home.comprar.numero2": "02",
  "home.comprar.numero3": "03",
  "home.comprar.paso1": "Elegí tu talle y agregá al carrito.",
  "home.comprar.paso2": "Confirmá por WhatsApp, te mandamos el link del pedido.",
  "home.comprar.paso3": "Pagá por transferencia o al recibir y te lo enviamos.",
  "home.comprar.nota": "Sin cuenta ni registro. Precios en guaraníes con IVA incluido.",
  "home.whatsapp.titulo": "Te asesoramos por WhatsApp",
  "home.whatsapp.texto": "Talles, colores, tiempos de entrega. Respondemos de 9 a 19 h.",
  "home.whatsapp.boton": "Escribinos",
  "home.whatsapp.mensaje": "Hola, quisiera asesoramiento sobre la colección de {tienda}.",
  "home.whatsapp.alt": "Modelo riendo en un balcon de Asuncion con conjunto de encaje coral y camisa de lino",
  // -------------------------------------------------------------------------
  // Header y pie
  // -------------------------------------------------------------------------
