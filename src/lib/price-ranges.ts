...
export const PRICE_RANGES = [
  { id: "0-100000", label: `Hasta ${formatGs(100000)}`, min: 0, max: 100000 as number | undefined },
  { id: "100000-300000", label: `${formatGs(100000)} a ${formatGs(300000)}`, min: 100000, max: 300000 },
  {
    id: "300000-1000000",
    label: `${formatGs(300000)} a ${formatGs(1000000)}`,
    min: 300000,
    max: 1000000,
  },
  { id: "1000000-", label: `Más de ${formatGs(1000000)}`, min: 1000000, max: undefined },
] as const;
